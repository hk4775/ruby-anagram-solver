...
# each line in the output should contain a set of input words that are anagrams of each other
#  No word should appear in the output more than once
#  Finding the longest anagram
#  set of anagram containg max words
...
module Anagram
  ...
  # finding the anagrams that is the longest
